...
Readonly our $shapeshifters_v5 => {
    C => 15, W => 3, P1 => 4, P2 => 4,
    FIRE => 1, WATER => 1,
    color => 'variable',
    board => 'variable',
    display => "Shapeshifters",
    full_name => 'shapeshifters_v5',
